...
export const startAuthenticationListener = (callbackWhenAuthenticated, callbackWhenUnauthenticated) => {
  firebase.auth().onAuthStateChanged(user => user ? callbackWhenAuthenticated(user) : callbackWhenUnauthenticated());
};
